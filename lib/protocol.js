...
var set_server_options = function(s) {
	server_options = s;
}
...
var serializers = {
        ...
        '_nsFlags': {
			...
			if (server_options != null) {
				// set authoritative aa bit to 1 if defined in the server options
				v.aa = server_options.authoritative || 0;
			}
                        var b = Buffer.alloc(2);
                        var f = 0x0000;
			...
			//console.log('binary', f.toString(2));
                        b.writeUInt16BE(f, 0);
                        return b;
                },
                decoder: function(v, p) {
